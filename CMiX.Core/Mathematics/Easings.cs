...
namespace CMiX.Core.Mathematics
{
    ...
    static public class Easings
    {
        ...
        /// </summary>
        static public double Interpolate(float p, Functions function)
        {
            switch (function)
            {
                default:
        ...
        /// <summary>
        /// </summary>
        static public double BounceEaseIn(float p)
        {
        ...
        /// <summary>
        /// </summary>
        static public double BounceEaseOut(float p)
        {
            if (p < 4 / 11.0f)
            {
        ...
        /// <summary>
        /// </summary>
        static public double BounceEaseInOut(float p)
        {
            if (p < 0.5f)
            {
